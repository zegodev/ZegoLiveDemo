...
//        mBorderWidth = a.getDimensionPixelSize(R.styleable.CirImageView_borderWidth1, DEFAULT_BORDER_WIDTH);
//        mBorderColor = a.getColor(R.styleable.CirImageView_borderColor1, DEFAULT_BORDER_COLOR);
//        a.recycle();
