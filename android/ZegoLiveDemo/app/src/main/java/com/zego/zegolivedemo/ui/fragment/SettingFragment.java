...
public class SettingFragment extends AbsBaseFragment {
    ...
    protected void initViews() {
        ...
        // 用户信息
        etUserAccount.setText(ZegoApiManager.getInstance().getZegoUser().id);
        etUserName.setText(ZegoApiManager.getInstance().getZegoUser().name);
    ...
    public void completeSetting(){
        ...
        // 设置用户信息
        ZegoUser user = ZegoApiManager.getInstance().getZegoUser();
        user.id = etUserAccount.getText().toString().trim();
        user.name = etUserName.getText().toString().trim();
        ZegoApiManager.getInstance().setZegoUser(user);
        ...
        ZegoApiManager.getInstance().setZegoAVConfig(config);
