...
public class LiveListAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LiveListAdapter(Context context, List<LiveVideo> videoList) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            return new LiveListHolder(mLayoutInflater.inflate(R.layout.item_video, parent, false));
        }
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof FooterViewHolder) {
            ...
            mImageLoader.displayImage(video.getScreenShotUrl(), ((LiveListHolder) holder).ivScreenShot);
            ((LiveListHolder) holder).tvUserName.setText(video.getUserName());
            ((LiveListHolder) holder).tvPublishTime.setText(video.getPublishTime());
