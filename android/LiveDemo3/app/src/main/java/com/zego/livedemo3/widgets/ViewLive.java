package com.zego.livedemo3.widgets;
...
public class ViewLive extends RelativeLayout {
    ...
    public void toFullScreen(ViewLive vlBigView, ZegoAVKit zegoAVKit){
        ...
        switch (streamOrdinalOfBigView) {
            ...
            case 1:
            case 2:
                zegoAVKit.setRemoteView(LiveUtils.getZegoRemoteViewIndexByOrdinal(streamOrdinalOfBigView), mTextureView);
                break;
        ...
        switch (streamOrdinalOfSmallView) {
            ...
            case 1:
            case 2:
                zegoAVKit.setRemoteView(LiveUtils.getZegoRemoteViewIndexByOrdinal(streamOrdinalOfSmallView), vlBigView.getTextureView());
                break;
            case PUBLISH_STREAM_ORDINAL:
