 ...
 * des:
 */
public class MixStreamPlayActivity extends MixstreamBaseLiveActivity {
    ...
    protected void doBusiness(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            // 登录业务房间
            BizLivePresenter.getInstance().loginExistedRoom(mRoomKey, mServerKey, PreferenceUtil.getInstance().getUserID(), BizLiveRoomUitl.USER_NAME_PREFIX_MIX_STREAM + PreferenceUtil.getInstance().getUserName());
...
//
//                    // 弹出对话框
//                    mDialogHandleRequestPublish = new AlertDialog.Builder(MixStreamPlayActivity.this).setTitle(getString(R.string.hint))
            ...
            public void onReceiveRespondMsg(boolean isRespondToMyRequest, boolean isAgree, String userNameOfRequest) {
                ...
                if (isRespondToMyRequest) {
                    if (isAgree) {
                        ...
                        AlertDialog dialogNotify = new AlertDialog.Builder(MixStreamPlayActivity.this).setTitle(getString(R.string.hint))
