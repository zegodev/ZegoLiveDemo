...
public:
    ...
    */
...
#if defined(ANDROID)
            log_v_debug("C %p, alloc: %p, own: %p", this, allocator_, ownAllocator_);
#endif
        }
    }
    ...
    {
#if defined(ANDROID)
        log_v_debug("%p, GenericDocument::GenericDocument(GenericDocument&& rhs)", this);
#endif
        rhs.allocator_ = 0;
        rhs.ownAllocator_ = 0;
    ...
    ~GenericDocument() {
#if defined(ANDROID)
        log_v_debug("D %p, alloc: %p, own: %p", this, allocator_, ownAllocator_);
#endif
        Destroy();
    }
    ...
    GenericDocument& operator=(GenericDocument&& rhs) RAPIDJSON_NOEXCEPT
    {
        ...
        rhs.parseResult_ = ParseResult();
#if defined(ANDROID)
        log_v_debug("%p, GenericDocument::operator=, Move assignment, allocator: %p, own: %p", this, allocator_, ownAllocator_);
#endif
        return *this;
    }
#endif
