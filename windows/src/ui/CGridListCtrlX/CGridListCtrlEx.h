...
public:
	...
	sigslot::signal1<int>& OnTraitSignal(void);
...
protected:
	...
	int m_nLastHotTrackRow;
	bool m_bTracking;
	sigslot::signal1<int> m_signalTraitAction;
	...
	virtual afx_msg BOOL OnHotTrack(NMHDR* pNMHDR, LRESULT* pResult);
	...
	virtual afx_msg void OnItemButtonClick(void);
	//}}AFX_MSG
